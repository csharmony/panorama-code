...
var ItemContextEntires = (function () {
  ...
  var _Entries = [
    {
      ...
      style: function (id) {
        ...
        return slotsub &&
          (slotsub.startsWith("equipment") || slotsub.startsWith("grenade"))
          ? ""
          : "BottomSeparator"
      },
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        ...
        return (
          defName === "casket" &&
          InventoryAPI.GetItemAttributeValue(id, "modification date")
        )
      },
      OnSelected: function (id) {
        $.DispatchEvent("ContextMenuEvent", "")
      ...
      AvailableForItem: function (id) {
        return (
          ...
          g_ActiveTournamentInfo.eventid ==
            InventoryAPI.GetItemAttributeValue(id, "tournament event id")
        )
      },
      OnSelected: function (id) {
        UiToolkitAPI.ShowCustomLayoutPopupParameters(
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        if (
          ...
          !ItemInfo.IsEquippedForCT(id) &&
          !ItemInfo.IsEquippedForT(id) &&
          !ItemInfo.IsShuffleEnabled(id, "t") &&
          !ItemInfo.IsShuffleEnabled(id, "ct")
        ) {
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        if (
          (ItemInfo.IsItemT(id) || ItemInfo.IsItemAnyTeam(id)) &&
          ItemInfo.IsShuffleEnabled(id, "t") &&
          !ItemInfo.IsItemInShuffleForTeam(id, "t") &&
          !InventoryAPI.IsItemDefault(id)
        ) {
          return _CanEquipItem(id)
        }
      },
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        if (
          (ItemInfo.IsItemCt(id) || ItemInfo.IsItemAnyTeam(id)) &&
          ItemInfo.IsShuffleEnabled(id, "ct") &&
          !ItemInfo.IsItemInShuffleForTeam(id, "ct") &&
          !InventoryAPI.IsItemDefault(id)
        ) {
          return _CanEquipItem(id)
        }
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return (
          ItemInfo.GetSlotSubPosition(id) === "flair0" &&
          (!ItemInfo.IsEquippedForNoTeam(id) ||
            InventoryAPI.GetRawDefinitionKey(id, "item_sub_position2") !== "")
        )
      },
      OnSelected: function (id) {
        $.DispatchEvent("ContextMenuEvent", "")
...

    {
      ...
      AvailableForItem: function (id) {
        return (
          ItemInfo.ItemMatchDefName(id, "spraypaint") &&
          !ItemInfo.IsEquippedForNoTeam(id)
        )
      },
      OnSelected: function (id) {
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return (
          ItemInfo.GetSlotSubPosition(id) === "musickit" &&
          !ItemInfo.IsEquippedForNoTeam(id) &&
          !ItemInfo.IsShuffleEnabled(id, "noteam")
        )
      },
      OnSelected: function (id) {
        $.DispatchEvent("ContextMenuEvent", "")
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return (
          ItemInfo.GetSlotSubPosition(id) === "musickit" &&
          ItemInfo.IsShuffleEnabled(id, "noteam") &&
          !ItemInfo.IsItemInShuffleForTeam(id, "noteam") &&
          !InventoryAPI.IsItemDefault(id)
        )
      },
      OnSelected: function (id) {
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        if (GameStateAPI.GetMapBSPName()) return false
        return (
          ItemInfo.ItemDefinitionNameSubstrMatch(id, "tournament_journal_") &&
          InventoryAPI.GetRawDefinitionKey(id, "item_sub_position2") ===
            "spray0"
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return (
          ItemInfo.ItemDefinitionNameSubstrMatch(id, "xpgrant") &&
          FriendsListAPI.GetFriendLevel(MyPersonaAPI.GetXuid()) >=
            InventoryAPI.GetMaxLevel()
        )
      },
      OnSelected: function (id) {
        UiToolkitAPI.ShowCustomLayoutPopupParameters(
      ...
      OnSelected: function (id) {
        if (ItemInfo.ItemDefinitionNameSubstrMatch(id, "tournament_pass_")) {
          ...
          UiToolkitAPI.ShowCustomLayoutPopupParameters(
            "",
            "file://{resources}/layout/popups/popup_inventory_inspect.xml",
            "itemid=" + id + "&" + "asyncworktype=useitem"
          )
        }
    ...
    {
      name: function (id) {
        return InventoryAPI.GetDecodeableRestriction(id) === "xray" &&
          !ItemInfo.IsTool(id)
          ? "look_inside"
          : _IsKeyForXrayItem(id) !== ""
            ? "goto_xray"
            : "open_package"
      },
      AvailableForItem: function (id) {
      ...
      OnSelected: function (id) {
        ...
        if (
          ItemInfo.GetChosenActionItemsCount(id, "decodable") > 0 &&
          ItemInfo.IsTool(id) &&
          InventoryAPI.GetDecodeableRestriction(id) === "xray"
        ) {
...

    {
      name: function (id) {
        ...
        var defName = InventoryAPI.GetItemDefinitionName(id)
        if (defName === "casket") {
          return InventoryAPI.GetItemAttributeValue(id, "modification date")
            ? "yourcasket"
            : "newcasket"
        }
      ...
      AvailableForItem: function (id) {
        ...
        return ["Name Tag", "casket"].includes(
          InventoryAPI.GetItemDefinitionName(id)
        )
      },
      OnSelected: function (id) {
        var defName = InventoryAPI.GetItemDefinitionName(id)
        if (defName === "casket") {
          var fauxNameTag = InventoryAPI.GetFauxItemIDFromDefAndPaintIndex(
            1200,
            0
          )
          var noteText = InventoryAPI.GetItemAttributeValue(
            id,
            "modification date"
          )
            ? "yourcasket"
          ...
          UiToolkitAPI.ShowCustomLayoutPopupParameters(
            ...
            "nametag-and-itemtoname=" +
              ...
              "&" +
              "asyncworkitemwarningtext=#popup_" +
              noteText +
              "_warning"
          )
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return (
          ...
          ItemInfo.ItemHasCapability(id, "can_sticker")
        )
      },
      OnSelected: function (id) {
    ...
    },
    {
      ...
      OnSelected: function (id) {
        ...
        UiToolkitAPI.ShowCustomLayoutPopupParameters(
          ...
          "sticker-and-itemtosticker=remove" +
            "," +
            id +
            "&" +
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return (
          ...
          ItemInfo.ItemHasCapability(id, "can_patch")
        )
      },
      OnSelected: function (id) {
        $.DispatchEvent("PlaySoundEffect", "sticker_applySticker", "MOUSE")
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return (
          ItemInfo.ItemHasCapability(id, "can_stattrack_swap") &&
          InventoryAPI.IsTool(id)
        )
      },
      OnSelected: function (id) {
        $.DispatchEvent("ContextMenuEvent", "")
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        return false
        var campaignSeason = InventoryAPI.GetItemAttributeValue(
          id,
          "season access"
        )
        var deployDate = InventoryAPI.GetItemAttributeValue(
          id,
          "deployment date"
        )
        return (
    ...
    },
    {
      ...
      AvailableForItem: function (id) {
        ...
        return (
          ...
          slot !== "clothing_hands" &&
          !ItemInfo.IsEquippalbleButNotAWeapon(id) &&
          (InventoryAPI.CanTradeUp(id) ||
            InventoryAPI.GetNumItemsNeededToTradeUp(id) > 0)
        )
      },
      OnSelected: function (id) {
        $.DispatchEvent("ContextMenuEvent", "")
    ...
    },
    {
      ...
      OnSelected: function (id) {
        ...
        var CapDisabledMessage =
          InventoryAPI.GetItemCapabilityDisabledMessageByIndex(id, 0)
    ...
    },
    {
      ...
      OnSelected: function (id) {
        ...
        if (ItemInfo.GetChosenActionItemsCount(id, "can_collect") > 0) {
          ...
          var fauxCasket = InventoryAPI.GetFauxItemIDFromDefAndPaintIndex(
            1201,
            0
          )
          UiToolkitAPI.ShowCustomLayoutPopupParameters(
  ...
  var _GetItemToReplaceName = function (id, team) {
    var currentEquippedItem = ItemInfo.GetItemIdForItemEquippedInLoadoutSlot(
      id,
      team
    )
    if (currentEquippedItem && currentEquippedItem !== "0") {
      $.GetContextPanel().SetDialogVariable(
        "item_name",
        _GetNameWithRarity(currentEquippedItem)
      )
  ...
  var _GetNameWithRarity = function (id) {
    ...
    return (
      '<font color="' + rarityColor + '">' + ItemInfo.GetName(id) + "</font>"
    )
  }
  ...
  var EquipItem = function (id, team, slot) {
    ...
    var teamShownOnMainMenu = GameInterfaceAPI.GetSettingString(
    ...
    if (ItemInfo.IsCharacter(id)) {
      var teamOfCharacter =
        ItemInfo.GetTeam(id).search("Team_T") === -1 ? "ct" : "t"
        ...
        if (
          ...
          slot ===
            GameInterfaceAPI.GetSettingString(
              "ui_vanitysetting_loadoutslot_" + teamShownOnMainMenu
            )
        ) {
          bNeedToRestartMainMenuVanity = true
        }
  ...
  var _DoesNotHaveChosenActionItems = function (id, capability) {
    return (
      ItemInfo.GetChosenActionItemsCount(id, capability) === 0 &&
      !ItemInfo.IsTool(id)
    )
  }
  ...
  var _ItemIsNotEquippedAndNotInShuffle = function (team, id) {
    return (
      !InventoryAPI.IsEquipped(id, team) && !ItemInfo.IsShuffleEnabled(id, team)
    )
  }

  var _IsInShuffleButNotEquippedWeaponTypeForSlot = function (team, id) {
    var currentlyEquippedId = LoadoutAPI.GetItemID(
      team,
      ItemInfo.GetSlotSubPosition(id)
    )
    var isSharedSlot = InventoryAPI.GetRawDefinitionKey(
      id,
      "item_shares_equip_slot"
    )
    var IsNotEquippedInSLot =
      InventoryAPI.GetItemDefinitionName(currentlyEquippedId) ===
      InventoryAPI.GetItemDefinitionName(id)

    return (
      ItemInfo.IsShuffleEnabled(id, team) &&
      !IsNotEquippedInSLot &&
      isSharedSlot === "1"
    )
  }
  ...
  var _CanEquipItem = function (itemID) {
    return (
      ItemInfo.GetSlotSubPosition(itemID) &&
      !ItemInfo.IsEquippableThroughContextMenu(itemID) &&
  ...
  var _IsKeyForXrayItem = function (id) {
    ...
    if (oData.case && oData.reward) {
      var numActionItems = ItemInfo.GetChosenActionItemsCount(
        oData.case,
        "decodable"
      )
      if (numActionItems > 0) {
        for (var i = 0; i < numActionItems; i++) {
          if (
            id ===
            ItemInfo.GetChosenActionItemIDByIndex(oData.case, "decodable", i)
          ) {
            return oData.case
          }
        }
