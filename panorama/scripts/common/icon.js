...
var IconUtil = (function () {
  var _SetPNGImageFallback = function (mapIconDetails, icon_image_path) {
    if (mapIconDetails.m_type == "svg") {
      ...
      $.UnregisterEventHandler(
        "ImageFailedLoad",
        mapIconDetails.m_icon,
        mapIconDetails.m_handler
      )
      mapIconDetails.m_icon.SetImage(
  ...
  var _SetupFallbackMapIcon = function (elIconPanel, icon_image_path) {
    ...
    var eventHandler = $.RegisterEventHandler(
      "ImageFailedLoad",
      elIconPanel,
      _SetPNGImageFallback.bind(undefined, mapIconDetails, icon_image_path)
    )
