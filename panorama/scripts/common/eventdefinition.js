...
;(function () {
  ...
  $.DefineEvent(
    ...
    "caseId",
    "showpopup",
    "The case id for the container to xray"
  )
  $.DefineEvent(
    "HideContentPanel",
    0,
  ...
  $.DefineEvent(
    ...
    0,
    "no args",
    "opens the stats page from anywhere."
  )
  ...
  $.DefineEvent(
    ...
    1,
    "auto close",
    "open the sidebar from a abutton click from anywhere pass setting if you wasnt it to autoclose"
  )
  $.DefineEvent(
    "StartDecodeableAnim",
    0,
  ...
  $.DefineEvent(
    ...
    1,
    "action",
    "Filter displayed coupons {apply|clear}"
  )
  $.DefineEvent(
    "AddItemToCart",
    1,
  ...
  $.DefineEvent(
    "PlayMenu_GoTeamMatchmaking_CodeGenerated",
    0,
    "no args",
    "Updates the generated direct challenge code in UI"
  )
  $.DefineEvent(
  ...
  $.DefineEvent(
    ...
    5,
    "titletxt,msgtxt,capability, itemid, itemid2",
  ...
  $.DefineEvent(
    ...
    "subslot",
    "team",
    "Open loadout panel for an item"
  )
  $.DefineEvent(
  ...
  $.DefineEvent(
    "SettingsMenu_NavigateToSetting",
    2,
    "category, settingPanelID",
  ...
  $.DefineEvent(
    "SettingsMenu_NavigateToSettingPanel",
    2,
    "category, settingPanel",
