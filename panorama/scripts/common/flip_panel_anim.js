...
var FlipPanelAnimation = (function () {
  ...
  FlipPanelAnimation.prototype.AddParamToCallbackData = function (
    param,
    value
  ) {
  ...
  FlipPanelAnimation.prototype.ControlBtnActions = function () {
    if (this.oData.controlBtnPrev) {
      this.oData.controlBtnPrev.SetPanelEvent(
        "onactivate",
        this.oData.funcCallback.bind(this, this.oData, true)
      )
      this.oData.controlBtnNext.SetPanelEvent(
        "onactivate",
        this.oData.funcCallback.bind(this, this.oData, false)
      )
  ...
  FlipPanelAnimation.prototype.DetermineVisiblePanel = function (
    animPanelA,
    animPanelB
  ) {
  ...
  FlipPanelAnimation.prototype.DetermineHiddenPanel = function (
    animPanelA,
    animPanelB
  ) {
    return !animPanelA.BHasClass("flip-panel-anim-down-show") &&
