...
var SessionUtil = (function () {
  var _DoesGameModeHavePrimeQueue = function (gameModeSettingName) {
    var bPrimeQueueSupported =
      gameModeSettingName === "competitive" ||
      gameModeSettingName === "scrimcomp2v2" ||
      gameModeSettingName === "survival"
  ...
  var _GetMaxLobbySlotsForGameMode = function (gameMode) {
    ...
    if (
      ...
      numLobbySlots = 2
    else if (gameMode === "survival") numLobbySlots = 2
