...
var FriendAdvertiseTile = (function () {
  ...
  var _SetNameAvatar = function (elTile) {
    ...
    elTile
      .FindChildTraverse("JsFriendAvatarBtn")
      .SetPanelEvent(
        "onactivate",
  ...
  var _SetPrime = function (elTile) {
    ...
    elTile.FindChildTraverse("JsFriendAdvertisePrime").visible =
  ...
  var _SetSkillGroup = function (elTile, gameMode) {
    ...
    var elSkillGroupImg = elTile.FindChildTraverse(
      "JsFriendAdvertiseSkillGroup"
    )
