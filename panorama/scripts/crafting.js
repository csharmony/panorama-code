...
var Crafting = (function () {
  ...
  var _UpdateButtons = function () {
    var elTradeUpConfirmBtn =
      $.GetContextPanel().FindChildTraverse("TradeUpConfirmBtn")
    elTradeUpConfirmBtn.enabled = InventoryAPI.IsCraftReady()
    if (!elTradeUpConfirmBtn.enabled) {
      elTradeUpConfirmBtn.checked = false
    }

    var elClearIngredientsBtn = $.GetContextPanel().FindChildTraverse(
      "ClearIngredientsBtn"
    )
...
;(function () {
  ...
  $.RegisterForUnhandledEvent(
    "UpdateTradeUpPanel",
    Crafting.UpdateCraftingPanelDisplay
  )
  $.RegisterForUnhandledEvent(
  ...
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_Inventory_CraftIngredientRemoved",
    Crafting.UpdateCraftingPanelDisplay
  )
})()
