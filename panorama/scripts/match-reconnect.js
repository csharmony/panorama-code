var MatchmakingReconnect = (function () {
  ...
  var _Init = function () {
    ...
    m_elOngoingMatch.OnPropertyTransitionEndEvent = function (
      panelName,
      propertyName
    ) {
      if (m_elOngoingMatch.id === panelName && propertyName === "opacity") {
        if (
          m_elOngoingMatch.visible === true &&
          m_elOngoingMatch.BIsTransparent()
        ) {
  ...
  var _SetUpButtons = function () {
    var btnReconnect = $.GetContextPanel().FindChildInLayoutFile(
    ...
    var btnAbandon =
      $.GetContextPanel().FindChildInLayoutFile("MatchmakingAbandon")
...
;(function () {
  ...
  $.RegisterForUnhandledEvent(
    ...
    MatchmakingReconnect.UpdateState
  )
