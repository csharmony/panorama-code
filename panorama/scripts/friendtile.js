...
var friendTile = (function () {
  ...
  var _Init = function (elTile) {
    ...
    if (_m_isClan) {
      ...
      if (!_m_clanHandle)
        _m_clanHandle = $.RegisterForUnhandledEvent(
  ...
  var _SetInvited = function (elTile, isInvited) {
    ...
    if (elInvited !== null) elInvited.SetHasClass("hidden", !isInvited)
  }
  ...
  var _SetOnActivateEvent = function (elTile) {
    ...
    elTile
      .FindChildTraverse("JsFriendTileBtn")
      .SetPanelEvent("onactivate", OpenContextMenu.bind(undefined, _m_xuid))
    elTile
      .FindChildTraverse("JsFriendTileBtn")
      .SetPanelEvent("oncontextmenu", OpenContextMenu.bind(undefined, _m_xuid))
  }
