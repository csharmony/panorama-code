...
var MainMenu = (function () {
  ...
  function UpdateSettingsMenuAlert() {
    ...
    if (elNewSettingsAlert) {
      let nNewSettings =
        PromotedSettingsUtil.GetUnacknowledgedPromotedSettings().length
  ...
  if (nNumNewSettings > 0) {
    var hPromotedSettingsViewedEvt = $.RegisterForUnhandledEvent(
      "MainMenu_PromotedSettingsViewed",
      function () {
        UpdateSettingsMenuAlert()
        $.UnregisterForUnhandledEvent(
          "MainMenu_PromotedSettingsViewed",
          hPromotedSettingsViewedEvt
        )
      }
    )
  }
  ...
  var _OnInitFadeUp = function () {
    if (!_m_playedInitalFadeUp) {
      ...
      if (GameInterfaceAPI.GetEngineSoundSystemsRunning()) {
        ...
        _m_hOnEngineSoundSystemsRunningRegisterHandle =
          $.RegisterForUnhandledEvent(
            "PanoramaComponent_GameInterface_EngineSoundSystemsRunning",
            MainMenu.ShowOperationLaunchPopup
          )
      }
    }
  }
  ...
  function _FetchTournamentData() {
    if (_m_jobFetchTournamentData) return
  ...
  var _SetBackgroundMovie = function () {
    ...
    var backgroundMovie = GameInterfaceAPI.GetSettingString(
      "ui_mainmenu_bkgnd_movie"
    )

    videoPlayer.SetAttributeString("data-type", backgroundMovie)

    videoPlayer.SetMovie(
      "file://{resources}/videos/" + backgroundMovie + ".webm"
    )
  ...
  var _OnShowMainMenu = function () {
    ...
    $("#MainMenuNavBarPlay").SetHasClass(
  ...
  var _TournamentDraftUpdate = function () {
    if (!m_TournamentPickBanPopup || !m_TournamentPickBanPopup.IsValid()) {
      m_TournamentPickBanPopup = UiToolkitAPI.ShowCustomLayoutPopup(
        "tournament_pickban_popup",
        "file://{resources}/layout/popups/popup_tournament_pickban.xml"
      )
    }
  }
  ...
  var _GcLogonNotificationReceived = function () {
    ...
    if (
      ...
      if (strFatalError === "ShowGameLicenseNeedToLinkAccountsWithMoreInfo") {
        UiToolkitAPI.ShowGenericPopupThreeOptionsBgStyle(
          "#CSGO_Purchasable_Game_License_Short",
          "#SFUI_LoginLicenseAssist_PW_NeedToLinkAccounts_WW_hint",
          "",
          "#UI_Yes",
          function () {
            SteamOverlayAPI.OpenURL(
              "https://community.csgo.com.cn/join/pwlink_csgo"
            )
          },
          "#UI_No",
          function () {},
          "#ShowFAQ",
          function () {
            _OnGcLogonNotificationReceived_ShowFaqCallback()
          },
          "dim"
        )
      } else if (strFatalError === "ShowGameLicenseNeedToLinkAccounts") {
        _OnGcLogonNotificationReceived_ShowLicenseYesNoBox(
          "#SFUI_LoginLicenseAssist_PW_NeedToLinkAccounts",
          "https://community.csgo.com.cn/join/pwlink_csgo"
        )
      } else if (strFatalError === "ShowGameLicenseHasLicensePW") {
        _OnGcLogonNotificationReceived_ShowLicenseYesNoBox(
          "#SFUI_LoginLicenseAssist_HasLicense_PW",
          "https://community.csgo.com.cn/join/pwlink_csgo?needlicense=1"
        )
        ...
        UiToolkitAPI.ShowGenericPopupOneOptionBgStyle(
          "#SFUI_LoginPerfectWorld_Title_Error",
          strFatalError,
          "",
          "#GameUI_Quit",
          function () {
    ...
    if (nAntiAddictionTrackingState > 0) {
      ...
      if (nAntiAddictionTrackingState != 2) {
        ...
        pszOverlayUrlToOpen =
          "https://community.csgo.com.cn/join/pwcompleteaccountinfo"
      }
      if (pszOverlayUrlToOpen) {
        UiToolkitAPI.ShowGenericPopupYesNo(
          pszDialogTitle,
          pszDialogMessageText,
          "",
          function () {
            SteamOverlayAPI.OpenURL(pszOverlayUrlToOpen)
          },
          function () {}
        )
      } else {
  ...
  var _OnGcLogonNotificationReceived_ShowLicenseYesNoBox = function (
    strTextMessage,
    pszOverlayUrlToOpen
  ) {
  ...
  var _OnGcLogonNotificationReceived_ShowFaqCallback = function () {
    SteamOverlayAPI.OpenURL(
      "https://support.steampowered.com/kb_article.php?ref=6026-IFKZ-7043&l=schinese"
    )
  ...
  var _OnShowPauseMenu = function () {
    ...
    var bIsCommunityServer =
      !_m_bPerfectWorld && MatchStatsAPI.IsConnectedToCommunityServer()
    ...
    $("#MainMenuNavBarSwitchTeams").SetHasClass(
      "mainmenu-navbar__btn-small--hidden",
      bTraining || bQueuedMatchmaking || bGotvSpectating
    )

    $("#MainMenuNavBarVote").SetHasClass(
      "mainmenu-navbar__btn-small--hidden",
      bTraining || bGotvSpectating
    )

    $("#MainMenuNavBarReportServer").SetHasClass(
      "mainmenu-navbar__btn-small--hidden",
      !bIsCommunityServer
    )

    $("#MainMenuNavBarShowCommunityServerBrowser").SetHasClass(
      "mainmenu-navbar__btn-small--hidden",
      !bIsCommunityServer
    )
  ...
  var _CanOpenStatsPanel = function () {
    if (
      GameInterfaceAPI.GetSettingString("ui_show_subscription_alert") !== "1"
    ) {
    ...
    var rtRecurringSubscriptionNextBillingCycle =
      InventoryAPI.GetCacheTypeElementFieldByIndex(
    ...
    if (!rtRecurringSubscriptionNextBillingCycle) {
      ...
      var rtTimeInitiated = InventoryAPI.GetCacheTypeElementFieldByIndex(
        "RecurringSubscription",
        0,
        "time_initiated"
      )
      if (rtTimeInitiated) return true
      else return false
    }
  ...
  var _NavigateToTab = function (tab, XmlName) {
    ...
    if (!$.GetContextPanel().FindChildInLayoutFile(tab)) {
      ...
      newPanel.BLoadLayout(
        "file://{resources}/layout/" + XmlName + ".xml",
        false,
        false
      )
      ...
      newPanel.OnPropertyTransitionEndEvent = function (
        panelName,
        propertyName
      ) {
      ...
      $.RegisterEventHandler(
        ...
        newPanel,
        newPanel.OnPropertyTransitionEndEvent
      )
    }
    ...
    if (_m_activeTab !== tab) {
      ...
      if (_m_activeTab) {
        var panelToHide =
          $.GetContextPanel().FindChildInLayoutFile(_m_activeTab)
  ...
  var _ShowHideNavDrawer = function () {
    UiToolkitAPI.ShowCustomLayoutPopup(
      "",
      "file://{resources}/layout/popups/popup_navdrawer.xml"
    )
  }
  ...
  var _DimMainMenuBackground = function (removeDim) {
    if (
      removeDim &&
      _m_elContentPanel.BHasClass("mainmenu-content--offscreen") &&
      $("#mainmenu-content__blur-target").BHasHoverStyle() === false
    ) {
      $("#MainMenuBackground").RemoveClass("Dim")
    } else $("#MainMenuBackground").AddClass("Dim")
  }
  ...
  var _InitFriendsList = function () {
    var friendsList = $.CreatePanel(
      "Panel",
      $.FindChildInContext("#mainmenu-sidebar__blur-target"),
      "JsFriendsList"
    )
    friendsList.BLoadLayout(
      "file://{resources}/layout/friendslist.xml",
      false,
      false
    )
  }
  ...
  var _InitNewsAndStore = function () {
    ...
    var elLimitedTest = $.CreatePanel(
      "Panel",
      $.FindChildInContext("#JsNewsContainer"),
      "JsLimitedTest"
    )
    elLimitedTest.BLoadLayout(
    ...
    var elNews = $.CreatePanel(
      "Panel",
      $.FindChildInContext("#JsNewsContainer"),
      "JsNewsPanel"
    )
    elNews.BLoadLayout(
      "file://{resources}/layout/mainmenu_news.xml",
      false,
      false
    )

    var elLastMatch = $.CreatePanel(
      "Panel",
      $.FindChildInContext("#JsNewsContainer"),
      "JsLastMatch"
    )
    elLastMatch.BLoadLayout(
      "file://{resources}/layout/mainmenu_lastmatch.xml",
      false,
      false
    )
    ...
    $.FindChildInContext("#JsNewsContainer").OnPropertyTransitionEndEvent =
      function (panelName, propertyName) {
  ...
  var _AddStream = function () {
    var elStream = $.CreatePanel(
      "Panel",
      $.FindChildInContext("#JsStreamContainer"),
      "JsStreamPanel"
    )
    elStream.BLoadLayout(
      "file://{resources}/layout/mainmenu_stream.xml",
      false,
      false
    )
  }
  ...
  var _AddFeaturedPanel = function (xmlPath, panelId) {
    ...
    $.FindChildInContext("#JsNewsContainer").MoveChildBefore(
      elPanel,
      $.FindChildInContext("#JsNewsPanel")
    )

    var overrideStyle =
      featuredXML.indexOf("tournament") !== -1 ||
      featuredXML.indexOf("operation") !== -1
        ? ""
  ...
  var _AddWatchNoticePanel = function () {
    ...
    $.FindChildInContext("#JsNewsContainer").MoveChildAfter(
      elPanel,
      $("#JsNewsPanel")
    )
  ...
  var _OnSteamIsPlaying = function () {
    ...
    if (elNewsContainer) {
      elNewsContainer.SetHasClass(
        "mainmenu-news-container-stream-active",
        EmbeddedStreamAPI.IsVideoPlaying()
      )
    }
  }
  ...
  function _RigVanityHover(vanityPanel) {
    if (!vanityPanel || !vanityPanel.IsValid()) return

    var elHover = $("#id-mainmenu-vanity-hover")

    if (!elHover || !elHover.IsValid) return
  ...
  var _ApplyVanitySettingsToLobbyMetadata = function (oSettings) {
    PartyListAPI.SetLocalPlayerVanityPresence(
      oSettings.team,
  ...
  var _SetVanityLightingBasedOnBackgroundMovie = function (vanityPanel) {
    var backgroundMap = $.GetContextPanel()
      .FindChildInLayoutFile("MainMenuMovie")
      .GetAttributeString("data-type", "anubis")
    ...
    if (backgroundMap === "cbble") {
      ...
      vanityPanel.SetFlashlightColor(0.81, 0.92, 1.0)
      ...
      vanityPanel.SetDirectionalLightColor(0.72, 1.4, 1.68)
      vanityPanel.SetDirectionalLightDirection(0.5, -0.69, -0.52)
    } else if (backgroundMap === "blacksite") {
      vanityPanel.SetFlashlightAmount(1)

      vanityPanel.SetFlashlightColor(4, 4, 4)
      vanityPanel.SetAmbientLightColor(0.16, 0.26, 0.3)

      vanityPanel.SetDirectionalLightModify(0)
      vanityPanel.SetDirectionalLightColor(0.26, 0.35, 0.47)
      vanityPanel.SetDirectionalLightDirection(-0.5, 0.8, 0.0)
      ...
      vanityPanel.SetDirectionalLightModify(2)
      vanityPanel.SetDirectionalLightColor(0.75, 1.2, 1.94)
      ...
      vanityPanel.SetDirectionalLightModify(0)
      vanityPanel.SetDirectionalLightColor(0.0, 0.19, 0.38)
  ...
  var _OpenPlayMenu = function () {
    if (MatchStatsAPI.GetUiExperienceType()) return
  ...
  var _OpenSubscriptionUpsell = function () {
    UiToolkitAPI.ShowCustomLayoutPopupParameters(
      "",
      "file://{resources}/layout/popups/popup_subscription_upsell.xml",
      ""
    )
  }
  ...
  var _OnEscapeKeyPressed = function (eSource, nRepeats, focusPanel) {
    if ($.GetContextPanel().BHasClass("MainMenuRootPanel--PauseMenuMode")) {
      ...
      if (
        elPlayButton &&
        !elPlayButton.BHasClass("mainmenu-navbar__btn-small--hidden")
      ) {
        GameInterfaceAPI.SetSettingString(
          "panorama_play_movie_ambient_sound",
          "1"
        )
  ...
  var _UpdateInventoryBtnAlert = function () {
    ...
    var elNavBar =
        $.GetContextPanel().FindChildInLayoutFile("JsMainMenuNavBar"),
  ...
  var _OnInventoryInspect = function (id) {
    UiToolkitAPI.ShowCustomLayoutPopupParameters(
      ...
      "itemid=" + id + "&" + "inspectonly=true" + "&" + "viewfunc=primary",
      "none"
    )
  }

  var _OnShowXrayCasePopup = function (
    toolid,
    caseId,
    bShowPopupWarning = false
  ) {
  ...
  var _OnLootlistItemPreview = function (id, params) {
    ...
    JsInspectCallback = UiToolkitAPI.RegisterJSCallback(function () {
      ...
      $.GetContextPanel()
        .FindChildInLayoutFile("PopupManager")
        .FindChildInLayoutFile("popup-inspect-" + idtoUse).visible = true
    })
    ...
    UiToolkitAPI.ShowCustomLayoutPopupParameters(
      ...
      "itemid=" +
        ...
        blurOperationPanel +
        "&" +
        "extrapopupfullscreenstyle=" +
        extrapopupfullscreenstyle +
        "&" +
        "showmarketlink=" +
        showMarketLinkDefault +
        "&" +
        "callback=" +
        JsInspectCallback +
        "&" +
  ...
  var _OpenDecodeAfterInspect = function (
    keyId,
    caseId,
    storeId,
    extrapopupfullscreenstyle,
    ...
    var backtodecodeparams =
      aParamsForCallback.length > 0 ? "&" + aParamsForCallback.join("&") : ""
  ...
  var _UpdateOverwatch = function () {
    ...
    $("#MainMenuNavBarOverwatch").SetHasClass(
      "mainmenu-navbar__btn-small--hidden",
      strCaseDescription == ""
    )
  }
  ...
  function _GetPopupNotification() {
    ...
    if (nBanRemaining < 0) {
      ...
      popupNotification.msg =
        $.Localize("#SFUI_CooldownExplanationReason_Expired_Cooldown") +
        $.Localize(CompetitiveMatchAPI.GetCooldownReason())
    ...
    if (strNotifications !== "") {
      ...
      arrayOfNotifications.forEach(function (notificationType) {
        ...
        popupNotification.title =
          "#SFUI_PersonaNotification_Title_" + notificationType
        popupNotification.msg =
          "#SFUI_PersonaNotification_Msg_" + notificationType
  ...
  function _UpdatePopupnotification() {
    if (!_m_bHasPopupNotification) {
      ...
      if (popupNotification != null) {
        ...
        if (popupNotification.html) elPopup.EnableHTML()
  ...
  function _GetNotificationBarData() {
    ...
    if (LicenseUtil.GetCurrentLicenseRestrictions() === false) {
      ...
      $("#MainMenuInput").SetHasClass(
        "GameClientConnectingToGC",
        !bIsConnectedToGC
      )
      if (bIsConnectedToGC) {
        ...
        Math.abs(+new Date() - _m_tLastSeenDisconnectedFromGC) > 7000
      ) {
    ...
    if (nIsVacBanned != 0) {
      ...
      if (nIsVacBanned == 1) {
        ...
        notification.link =
          "https://help.steampowered.com/faqs/view/4E54-0B96-D0A4-1557"
      }
    ...
    if (nBanRemaining > 0) {
      ...
      if (!CompetitiveMatchAPI.CooldownIsPermanent()) {
        ...
        notification.title =
          title + " " + FormatText.SecondsToSignificantTimeString(nBanRemaining)
      }
  ...
  function _UpdateNotificationBar() {
    ...
    if (notification !== null) {
      if (notification.link) {
        ...
        btnClickableLink.SetPanelEvent("onactivate", (_) =>
          SteamOverlayAPI.OpenUrlInOverlayOrExternalBrowser(notification.link)
        )
        notification.title =
          "<span class='fairplay-link'>" + notification.title + "</span>"
      }

      $.FindChildInContext("#MainMenuNotificationTitle").text =
        notification.title
    }
  ...
  var _ShowAcknowledgePopup = function (type = "", itemid = "") {
    ...
    if (!_m_acknowledgePopupHandler) {
      ...
      jsPopupCallbackHandle = UiToolkitAPI.RegisterJSCallback(
        MainMenu.ResetAcknowlegeHandler
      )
  ...
  var _ShowStoreStatusPanel = function (
    strText,
    bAllowClose,
    bCancel,
    strOkCmd
    ...
    if (currentVersion !== setVersionTo) {
      ...
      function showMp5Popup() {
        ...
        UiToolkitAPI.ShowCustomLayoutPopupParameters(
          ...
          "defindex=" + defIndex + "&" + "uisettingversion=" + setVersionTo,
          "none"
        )
      }
    }
  ...
  var _ShowOperationLaunchPopup = function () {
    ...
    if (elCoverPlaque) elCoverPlaque.visible = false
  ...
  function _AddPauseMenuMissionPanel() {
    ...
    if (
      !$.GetContextPanel().FindChildInLayoutFile("JsActiveMission") &&
      missionId &&
      oGameState &&
      oGameState.gamephase !== 5
    ) {
      elPanel = $.CreatePanel(
        "Panel",
      ...
      elPanel.BLoadLayout(
        "file://{resources}/layout/operation/operation_active_mission.xml",
        false,
        false
      )
    } else {
  ...
  function _DeletePauseMenuMissionPanel() {
    if ($.GetContextPanel().FindChildInLayoutFile("JsActiveMission")) {
      $.GetContextPanel()
        .FindChildInLayoutFile("JsActiveMission")
        .DeleteAsync(0.0)
    }
  }
  ...
  var _UpdateUnlockCompAlert = function () {
    ...
    var bHide =
      GameInterfaceAPI.GetSettingString("ui_show_unlock_competitive_alert") ===
        "1" ||
  ...
  function _OnGoToCharacterLoadoutPressed() {
    ...
    var team =
      GameInterfaceAPI.GetSettingString("ui_vanitysetting_team") == "t" ? 2 : 3

    var elVanityContextMenu =
      UiToolkitAPI.ShowCustomLayoutContextMenuParametersDismissEvent(
...
;(function () {
  ...
  $.RegisterForUnhandledEvent(
    ...
    MainMenu.OnSideBarElementContextMenuActive
  )
  ...
  $.RegisterForUnhandledEvent(
    ...
    MainMenu.OpenSubscriptionUpsell
  )
  ...
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_MyPersona_GameMustExitNowForAntiAddiction",
    MainMenu.GameMustExitNowForAntiAddiction
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_MyPersona_GcLogonNotificationReceived",
    MainMenu.GcLogonNotificationReceived
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_MyPersona_BetaEnrollmentStatusChange",
    MainMenu.BetaEnrollmentStatusChange
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_GC_Hello",
    MainMenu.UpdateUnlockCompAlert
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_MyPersona_InventoryUpdated",
    MainMenu.InventoryUpdated
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_Lobby_MatchmakingSessionUpdate",
    MainMenu.LobbyPlayerUpdated
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_Lobby_PlayerUpdated",
    MainMenu.LobbyPlayerUpdated
  )
  $.RegisterForUnhandledEvent(
    "InventoryItemPreview",
    MainMenu.OnInventoryInspect
  )
  $.RegisterForUnhandledEvent(
    "LootlistItemPreview",
    MainMenu.OnLootlistItemPreview
  )
  $.RegisterForUnhandledEvent("ShowXrayCasePopup", MainMenu.OnShowXrayCasePopup)
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_Inventory_WeaponPreviewRequest",
    MainMenu.WeaponPreviewRequest
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_Overwatch_CaseUpdated",
    MainMenu.UpdateOverwatch
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_TournamentMatch_DraftUpdate",
    MainMenu.TournamentDraftUpdate
  )

  $.RegisterForUnhandledEvent(
    "ShowAcknowledgePopup",
    MainMenu.ShowAcknowledgePopup
  )
  $.RegisterForUnhandledEvent(
    "ShowStoreStatusPanel",
    MainMenu.ShowStoreStatusPanel
  )
  $.RegisterForUnhandledEvent(
    "HideStoreStatusPanel",
    MainMenu.HideStoreStatusPanel
  )

  $.RegisterForUnhandledEvent("ShowVoteContextMenu", MainMenu.ShowVote)
  $.RegisterForUnhandledEvent(
    "ShowTournamentStore",
    MainMenu.ShowTournamentStore
  )

  $.RegisterForUnhandledEvent(
    "UnloadLoadingScreenAndReinit",
    MainMenu.ResetSurvivalEndOfMatch
  )

  $.RegisterForUnhandledEvent(
    "MainMenu_OnGoToCharacterLoadoutPressed",
    MainMenu.OnGoToCharacterLoadoutPressed
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_EmbeddedStream_VideoPlaying",
    MainMenu.OnSteamIsPlaying
  )
  $.RegisterForUnhandledEvent("StreamPanelClosed", MainMenu.ResetNewsEntryStyle)
  $.RegisterForUnhandledEvent(
    "HideMainMenuNewsPanel",
    MainMenu.HideMainMenuNewsPanel
  )

  $.RegisterForUnhandledEvent("ForceRestartVanity", MainMenu.ForceRestartVanity)

  $.RegisterForUnhandledEvent(
    "CSGOMainInitBackgroundMovie",
  ...
  $.RegisterForUnhandledEvent(
    "MainMenuGoToCharacterLoadout",
    MainMenu.GoToCharacterLoadout
  )
