...
var EventschedTeamContextMenu = (function () {
  ...
  function _Init() {
    ...
    player_photo_url[0] = $.GetContextPanel().GetAttributeString(
      "player_photo0",
      ""
    )
    player_photo_url[1] = $.GetContextPanel().GetAttributeString(
      "player_photo1",
      ""
    )
    player_photo_url[2] = $.GetContextPanel().GetAttributeString(
      "player_photo2",
      ""
    )
    player_photo_url[3] = $.GetContextPanel().GetAttributeString(
      "player_photo3",
      ""
    )
    player_photo_url[4] = $.GetContextPanel().GetAttributeString(
      "player_photo4",
      ""
    )
    ...
    var elTeamLogo = $.GetContextPanel().FindChildTraverse(
      "id-estt-header__team-logo"
    )
    if (elTeamLogo) {
    ...
    if (elTeamHeader && team_url !== "") {
      ...
      elTeamHeader.SetPanelEvent(
        "onactivate",
        onActivate.bind(undefined, team_url)
      )
    }
  ...
  function _Populate() {
    var elPlayerContainer = $.GetContextPanel().FindChildTraverse(
      "id-estt-lineup-container"
    )
    ...
    for (var idx = 0; idx < 5; idx++) {
      ...
      if (player_url[idx] !== "") {
        ...
        elPlayer.SetPanelEvent(
          "onactivate",
          onActivate.bind(undefined, player_url[idx])
        )
      }
    }
  }
