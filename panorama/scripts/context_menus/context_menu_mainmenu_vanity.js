...
var MainMenuVanityContextMenu = (function () {
  ...
  function _Init() {
    ...
    var elContextMenuBodyNoScroll = $.GetContextPanel().FindChildTraverse(
      "ContextMenuBodyNoScroll"
    )
    var elContextMenuBodyWeapons = $.GetContextPanel().FindChildTraverse(
      "ContextMenuBodyWeapons"
    )

    elContextMenuBodyNoScroll.RemoveAndDeleteChildren()
    elContextMenuBodyWeapons.RemoveAndDeleteChildren()

    var fnAddVanityPopupMenuItem = function (
      idString,
      strItemNameString,
      fnOnActivate
    ) {
    ...
    fnAddVanityPopupMenuItem(
      "GoToMainMenuScenerySettings",
    ...
    fnAddVanityPopupMenuItem(
      "switchTo_" + strOtherTeamToPrecache,
      "#mainmenu_switch_vanity_to_" + strOtherTeamToPrecache,
      function (paramTeam) {
    ...
    fnAddVanityPopupMenuItem(
      "GoToLoadout",
      "#mainmenu_go_to_character_loadout",
      function (paramTeam) {
        ...
        elItem.SetPanelEvent(
          ...
          function (team) {
            ...
            GameInterfaceAPI.SetSettingString(
              "ui_vanitysetting_loadoutslot_" + shortTeam,
              loadoutSubSlot
            )
    ...
    var otherTeamCharacterItemID = LoadoutAPI.GetItemID(
      strOtherTeamToPrecache,
      "customplayer"
    )
    var settingsForOtherTeam = ItemInfo.GetOrUpdateVanityCharacterSettings(
      otherTeamCharacterItemID
    )
