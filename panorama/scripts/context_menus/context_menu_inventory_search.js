...
var InventorySearch = (function () {
  var m_elList = $.GetContextPanel().FindChildInLayoutFile(
    "ContextMenuSearchResultsList"
  )
  var m_elTextEntry = $.GetContextPanel().FindChildInLayoutFile(
    "InventorySearchInput"
  )
  var m_elNoResults =
    $.GetContextPanel().FindChildInLayoutFile("SearchNoResults")
  var m_elSuggestedSearches = $.GetContextPanel().FindChildInLayoutFile(
  ...
  var _UpdateItemList = function () {
    ...
    $.Schedule(
      0.15,
      _NoSearchResults.bind(undefined, m_elTextEntry.text === "")
    )
  }
