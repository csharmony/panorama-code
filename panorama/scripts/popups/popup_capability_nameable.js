...
var CapabilityNameable = (function () {
  var m_Inspectpanel = $.GetContextPanel(),
    m_elTextEntry =
      $.GetContextPanel().FindChildInLayoutFile("NameableTextEntry"),
    m_elNameTagModel = $.GetContextPanel().FindChildInLayoutFile(
      "NameableNameTagModel"
    ),
    m_elRemoveConfirm = $.GetContextPanel().FindChildInLayoutFile(
      "NameableRemoveConfirm"
    ),
    m_elValidBtn =
      $.GetContextPanel().FindChildInLayoutFile("NameableValidBtn"),
    m_elRemoveBtn =
      $.GetContextPanel().FindChildInLayoutFile("NameableRemoveBtn")

  var m_itemId = ""
  var m_toolId = ""

  var _Init = function () {
    var strMsg = $.GetContextPanel().GetAttributeString(
  ...
  var _ShowPurchase = function (toolId) {
    ...
    InpsectPurchaseBar.Init(elPurchase, fakeItem, _GetSettingCallback)
  }
  ...
  var _AsyncActionPerformedCallback = function () {
    m_Inspectpanel.FindChildInLayoutFile("NameableRemoveConfirm").enabled =
      false
  ...
  var _SetUpButtonStates = function (toolId, itemId, hasName, noTool) {
    ...
    m_elRemoveConfirm.SetPanelEvent(
      "onactivate",
    ...
    var onMouseOver = function (isValid) {
      if (!isValid)
        UiToolkitAPI.ShowTextTooltip(
          "NameableValidBtn",
          "#tooltip_nameable_invalid"
        )
    }

    m_elValidBtn.SetPanelEvent(
      "onmouseover",
      onMouseOver.bind(undefined, isValid)
    )
...
;(function () {
  $.RegisterForUnhandledEvent(
    ...
    CapabilityNameable.NameTagAcquired
  )
})()
