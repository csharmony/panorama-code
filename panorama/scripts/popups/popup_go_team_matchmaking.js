...
var PopupGoTeamMatchmaking = (function () {
  ...
  var _RandomCode = function () {
    ...
    UiToolkitAPI.ShowTextTooltip(
      "RandomCode",
      "#PopupGoTeamMatchmaking_DirectChallenge_Random"
    )
  }
  ...
  var _CopyCode = function () {
    ...
    UiToolkitAPI.ShowTextTooltip(
      "CopyCode",
      "#PopupGoTeamMatchmaking_DirectChallenge_Copied"
    )
  }
  ...
  var _GO = function (how) {
    switch (how) {
      ...
      case "direct":
        ...
        let elTextEntry = $("#CodeTextEntry")
        if (elTextEntry.text) {
          code0 = CompetitiveMatchAPI.ValidateDirectChallengeCode(
        ...
        if (!code0 || !code1) {
          ...
          UiToolkitAPI.ShowGenericPopupYesNo(
            "#PopupGoTeamMatchmaking_DirectChallenge_Explain_Title",
            "#PopupGoTeamMatchmaking_DirectChallenge_Explain",
            "",
            function () {
              CompetitiveMatchAPI.GenerateDirectChallengeCode()
              SteamOverlayAPI.CopyTextToClipboard(
                CompetitiveMatchAPI.GetDirectChallengeCode().toUpperCase()
              )
...
;(function () {
  $.RegisterForUnhandledEvent(
    ...
    PopupGoTeamMatchmaking.CodeRegenerated
  )
})()
