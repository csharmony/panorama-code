...
var _strStoreProceedAfterCheckoutConfirmation =
  "StoreProceedAfterCheckoutConfirmation"
...
var SetupPopup = function () {
  ...
  var bPurchaseConfirmation = _strStoreStatusOkCmd.startsWith(
    _strStoreProceedAfterCheckoutConfirmation
  )
  var elPurchaseConfirmation = $("#PurchaseConfirmation")
  elPurchaseConfirmation.visible = bPurchaseConfirmation
  var sPurchaseConfirmation = bPurchaseConfirmation
    ? _strStoreStatusOkCmd.slice(
        1 + _strStoreProceedAfterCheckoutConfirmation.length
      )
    : ""
  elPurchaseConfirmation.text = sPurchaseConfirmation
    ? sPurchaseConfirmation
    : $.Localize("#SFUI_MBox_OKButton")
...
function OnOKPressed() {
  if (_strStoreStatusOkCmd) {
    if (
      _strStoreStatusOkCmd.startsWith(_strStoreProceedAfterCheckoutConfirmation)
    )
      StoreAPI.StoreProceedAfterCheckoutConfirmation()
    else GameInterfaceAPI.ConsoleCommand(_strStoreStatusOkCmd)
  }
