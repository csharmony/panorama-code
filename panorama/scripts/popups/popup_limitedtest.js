...
var PopupLimitedTest = (function () {
  ...
  function _OnOKPressed() {
    ...
    $.GetContextPanel().FindChildInLayoutFile(
      "id-popup-limited-test-download-btn"
    ).visible = false
    $.GetContextPanel().FindChildInLayoutFile(
      "id-popup-limited-test-info-btn"
    ).enabled = false
    $.GetContextPanel().FindChildInLayoutFile(
      "id-popup-limited-test-close-btn"
    ).enabled = false
    $.GetContextPanel()
      .FindChildInLayoutFile("id-popup-limited-test-spinner")
  ...
  function _BetaEnrollmentStatusChange() {
    ...
    if (strMyBetaStatus === "enrolled") {
      ...
      $.GetContextPanel()
        .FindChildInLayoutFile("id-popup-limited-test-check")
        .SetHasClass("hidden", false)
      $.GetContextPanel()
        .FindChildInLayoutFile("id-popup-limited-warning")
        .SetHasClass("hidden", false)
      $.GetContextPanel()
        .FindChildInLayoutFile("id-popup-limited-test-quit-btn")
        .SetHasClass("hidden", false)
      $.GetContextPanel().FindChildInLayoutFile(
        "id-popup-limited-test-info-btn"
      ).enabled = true
...
;(function () {
  $.RegisterForUnhandledEvent(
    ...
    PopupLimitedTest.BetaEnrollmentStatusChange
  )
})()
