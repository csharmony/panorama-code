...
var PopupConfirmPickemPicks = (function () {
  ...
  var _ShowStickers = function () {
    ...
    var elStickerItemImages = $.GetContextPanel().FindChildInLayoutFile(
      "id-popup-confirm-apply"
    )
  ...
  var _ShowTeams = function () {
    ...
    var elTeamItemImages = $.GetContextPanel().FindChildInLayoutFile(
      "id-popup-confirm-purchase"
    )
  ...
  var _ShowAllClearingMsg = function () {
    ...
    var elStickerItemImages = $.GetContextPanel().FindChildInLayoutFile(
      "id-popup-confirm-clearall"
    )
    elStickerItemImages.visible =
      aPicksForConfirm.length <= 0 && aTeamIds.length <= 0
  }
  ...
  var _ApplyPicks = function () {
    ...
    $.GetContextPanel().FindChildInLayoutFile(
      "id-popup-confrim-apply-btn"
    ).enabled = false
    $.GetContextPanel()
      .FindChildInLayoutFile("id-popup-confirm-spinner")
      .RemoveClass("hidden")
    PredictionsAPI.SetMyPredictionUsingItemID.apply(
      PredictionsAPI,
      $.GetContextPanel()._oPicksData.args
    )
