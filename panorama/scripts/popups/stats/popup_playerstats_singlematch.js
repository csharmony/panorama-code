...
var singlematch = (function () {
  ...
  function _Appear() {
    ...
    _m_EventHandle = $.RegisterForUnhandledEvent(
      "PanoramaComponent_MatchInfo_StateChange",
      _OnMatchReadyForDisplay
    )
  ...
  function _PopulateMatchInfo(parentPanel) {
    var activeMatchInfoPanel =
      $.GetContextPanel().FindChildTraverse("MatchInfo")

    activeMatchInfoPanel.matchId = _m_sToken
    activeMatchInfoPanel.matchListDescriptor = _m_matchId
    activeMatchInfoPanel.BLoadLayout(
