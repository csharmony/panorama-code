...
var PopupRedeemSouvenir = (function () {
  ...
  var _Init = function () {
    $.GetContextPanel().FindChildInLayoutFile("popup-redeem-spinner").visible =
      false
    m_tournamentIndex = $.GetContextPanel().GetAttributeString(
      "tournamentindex",
      ""
    )
  ...
  var _SetMatchTile = function () {
    var elMatchtile = $.CreatePanel(
      "Panel",
      $.GetContextPanel().FindChildInLayoutFile("id-popup-matchtile-redeem"),
      "id-match-tile",
      {
    ...
    elMatchtile.BLoadLayout(
      "file://{resources}/layout/matchtiles/tournament.xml",
      false,
      false
    )
  ...
  var _OnRedeem = function () {
    ...
    m_scheduleHandle = $.Schedule(
      5,
      _CancelWaitforCallBack.bind(undefined, $.GetContextPanel())
    )
    $.GetContextPanel().FindChildInLayoutFile("popup-redeem-spinner").visible =
      true
    $.GetContextPanel().FindChildInLayoutFile("id-popup-redeem-btn").visible =
      false
...
;(function () {
  $.RegisterForUnhandledEvent(
    ...
    PopupRedeemSouvenir.ItemCustomizationNotification
  )
})()
