...
var PopupPrimeStatus = (function () {
  var m_bIsPerfectWorld =
    MyPersonaAPI.GetLauncherType() === "perfectworld" &&
    !GameInterfaceAPI.HasCommandLineParm("-forceperfectworld")
      ? true
      : false
...
;(function () {
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_MyPersona_ElevatedStateUpdate",
    PopupPrimeStatus.UpdateEleveatedStatusPanel
  )
})()
