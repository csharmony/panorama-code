...
function PanelTypeTab(panelType, layoutType) {
  ...
  var container = $.CreatePanel(
    "Panel",
    $.FindChildInContext("#TestContent"),
    panelId,
    { class: "debug-tester--" + layoutType }
  )
  var debugControls = $.CreatePanel("Panel", container, "DebugControls", {
    class: "debug-tester-controls"
  })
  var testPanelContainer = $.CreatePanel("Panel", container, "", {
    class: "debug-tester-panelholder"
  })
...
function LayoutTab(testName, xml) {
  ...
  var xml =
    xml == "" || xml == undefined
      ? "file://{resources}/layout/tests/" + testName + ".xml"
      : xml
