...
var freezePanel = (function () {
  var _OnSetFlairEvent = function (xuid, skillgroup) {
    ...
    if (flairItemImage !== "") {
      ...
      elAvatarFlair.SetImage(
        "file://{images_econ}" + flairItemImage + "_small.png"
      )
      elAvatarFlairSS.RemoveClass("FreezePanel__AvatarFlair--Hidden")
      elAvatarFlairSS.SetImage(
        "file://{images_econ}" + flairItemImage + "_small.png"
      )
    ...
    if (skillgroup) {
      elPlayerAvatarSkillGroup.SetImage(
        "file://{images}/icons/skillgroups/dangerzone" + skillgroup + ".svg"
      )
      elPlayerAvatarSkillGroup.RemoveClass(
        "FreezePanel__AvatarSkillGroup--Hidden"
      )
    } else {
...
;(function () {
  $.RegisterEventHandler(
    "CSGOHudFreezePanelSetFlair",
    $.GetContextPanel(),
    freezePanel.OnSetFlairEvent
  )
})()
