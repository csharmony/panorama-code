...
var NewsPanel = (function () {
  ...
  var _OnRssFeedReceived = function (feed) {
    ...
    if (elLister === undefined || elLister === null || !feed) return
    ...
    feed["items"].forEach(function (item, i) {
      ...
      var lastReadItem = GameInterfaceAPI.GetSettingString(
      ...
      elEntry
        .FindChildInLayoutFile("NewsEntryBlurTarget")
        .AddBlurPanel(elEntryInfo)

      elEntry.SetPanelEvent(
        "onactivate",
        function (link, elEntry, clearNew) {
