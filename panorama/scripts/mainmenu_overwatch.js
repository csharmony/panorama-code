...
var mainmenu_overwatch = (function () {
  ...
  function _ShowVerdictPopup() {
    if (!_m_overwatchPopupPanel || !_m_overwatchPopupPanel.IsValid()) {
      _m_overwatchPopupPanel = UiToolkitAPI.ShowGlobalCustomLayoutPopup(
        "PopupVerdict",
        "file://{resources}/layout/popups/popup_mainmenu_overwatch_verdict.xml",
        ""
      )
    }
  }
...
;(function () {
  ...
  $.RegisterEventHandler(
    "ReadyForDisplay",
    elJsMainMenuOverwatch,
    mainmenu_overwatch.OnReadyForDisplay
  )

  $.RegisterForUnhandledEvent(
    "PanoramaComponent_Overwatch_CaseUpdated",
    mainmenu_overwatch.CaseUpdated
  )
  $.RegisterForUnhandledEvent(
    "PanoramaComponent_Overwatch_DemoFileEndReached",
    mainmenu_overwatch.ShowVerdictPopup
  )
})()
